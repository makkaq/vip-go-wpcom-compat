<article id="post-<?php the_ID(); ?>" <?php post_class( 'first-featured' ); ?>>
	<div class="first-featured__image" style="background-image: url('<?php echo esc_url( sophos_get_the_post_thumbnail() ); ?>');">
	</div>
	<div class="first-featured__content">
			...
			<div class="featured-entry-meta">
				...
				<div class="featured-entry-categories">
					<ul class="post-categories">
						<?php echo wp_kses( sophos_term_listing( '', true, true ), [
							'li' => [],
							'a' => [
								'href' => 1,
							],
