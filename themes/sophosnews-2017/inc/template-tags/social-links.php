 ...
 */
	...
	<ul class="social-sharing" id="social-sharing">
		...
		<li class="twitter"><a class="js-share-modal" href="http://twitter.com/home?status=<?php echo rawurlencode( get_the_title() . ' ' . wp_get_shortlink() ); ?>" data-title="<?php esc_attr( get_the_title() ); ?>" title="<?php esc_html_e( 'Share on Twitter', 'sophos-news' ); ?>"><?php esc_html_e( 'Share on Twitter', 'sophos-news' ); ?></a></li>
