...
/**
 * Template Name: Full Width - Excerpt overlay Image
		...
		<div id="primary" class="content-area">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<header class="entry-header">
					...
					<?php
					/**
					 * Preserve the article layout if a featured-image is not set
					 * by adding an (empty) .entry-featured-image element.
					 */
					?>
